    ...
    return (
        <div id="carouselExampleDark" className="carousel slide" data-bs-ride="carousel">
            ...
            <div className="carousel-inner">
                ...
                <img src="/assets/Home_Background_Image_1.webp" className="d-block image-size" alt="No IMage" />
                ...
                <img src="/assets/Home_Background_Image_2.webp" className="d-block image-size" alt="..." />
                <div className="carousel-caption d-md-block text-light fw-bold carousel-text-alignment">
                ...
                <div className="carousel-item" data-bs-interval="3000">
                <img src="/assets/Home_Background_Image_3.webp" className="d-block image-size" alt="..." />
                <div className="carousel-caption d-md-block text-light fw-bold carousel-text-alignment">
